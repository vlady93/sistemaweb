    ...
    <div class="form-group col-md-4">
        <div class="form-group">
            ...
            <select class="form-control" name="id_admin" id="id_admin"">
                <option value="" disabled selected>Selecccione un Administrador</option>
    ...
    <div class="form-group col-md-4">
        <div class="form-group">
            ...
            <select class="form-control" name="id_logistic" id="id_logistic">
                <option value="" disabled selected>Selecccione Logistica</option>
    ...
    <div class="form-group col-md-4">
        <div class="form-group">
            ...
            <select class="form-control" name="city_id" id="city_id">
                <option value="" disabled selected>Selecccione unsa Ciudad</option>
