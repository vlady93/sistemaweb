                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" id="email" placeholder="ejemplo@email.com"
                                required>
                            @error('email')
                                <small>*{{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="nit_number" id="nit_number" placeholder="NIT"
                                required>
                            @error('nit_number')
                                <small class="text-danger">*{{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="phone" id="phone" placeholder="Teléfono/Celular"
                                required>
                            @error('phone')
                                <small class="text-danger">*{{ $message }}</small>
                            @enderror
