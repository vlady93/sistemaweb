        ...
        <div>
            <table id="" class="ml-4 ">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>HORA: :</th>
                        <td>{{\Carbon\Carbon::parse($purchase->created_at)->format('h:i a')}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <table id="facproducto" class="table table_condensed table-bordered table-striped text-center">
                ...
                <tbody>
                    @foreach ($purchaseDetails as $purchaseDetail)
                        <tr>
                            ...
                            <td> <small> {{ $purchaseDetail->product->name }} -
                                    {{ $purchaseDetail->product->caract }}</small></td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td>
                            <p align="right">{{ number_format($purchase->total, 2) }} Bs.-
                            <p>
                        </td>
                    </tr>
