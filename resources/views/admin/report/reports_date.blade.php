            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @else
                     ...
                     <div class="row">
                        <h4 class="col-12 card-title font-weight-bold p-3 mb-2 bg-dark text-white text-center">Reporte : {{\Carbon\Carbon::parse($fini)->format('d M y')}} - {{\Carbon\Carbon::parse($ffin)->format('d M y')}}</h4>
                    ...
                    <div class="table-responsive">
                        <table id="order-listing" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">
                                        <a href="{{route('sales.show', $sale)}}">{{$sale->name}}</a>
                                    </th>
