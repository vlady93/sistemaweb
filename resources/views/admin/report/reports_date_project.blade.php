        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::open(['route'=>'report.results_project', 'method'=>'POST']) !!}
                    ...
                    @else
                     ...
                     <div class="row">
                        <h4 class="col-12 card-title font-weight-bold p-3 mb-2 bg-dark text-white text-center">Reporte : {{\Carbon\Carbon::parse($finipr)->format('d M y')}} - {{\Carbon\Carbon::parse($ffinpr)->format('d M y')}}</h4>
