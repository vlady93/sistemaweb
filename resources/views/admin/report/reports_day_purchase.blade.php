...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">
            Reporte de Ingresos de Material Diario
        </h3>
                    ...
                    <div class="table-responsive">
                        <table id="order-listing" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">
                                        <a href="{{route('sales.show', $purchase)}}">{{$purchase->id}}</a>
                                    </th>
                                    <td>
                                        {{\Carbon\Carbon::parse($purchase->purchases_date)->format('d M y h:i a')}}
                                    </td>
                                    <td>{{$purchase->total}}</td>
                                    <td>{{$purchase->status}}</td>
                                    <td style="width: 50px;">
                                       
                                        {{--  <a class="jsgrid-button jsgrid-edit-button" href="{{route('sales.edit', $purchase)}}" title="Editar">
